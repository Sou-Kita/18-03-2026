...
module.exports = {
  ...
  CreateAnUserValidator: [
    ...
    body("password")
      ...
      .withMessage(
        " password it naht 8 ki tu trong do co it nhat 1 ki tu dac biet, 1 ki tu in hoa, 1 ki tu thuong , 1 ki tu so",
      ),
    body("avatarUrl")
      .optional({
        checkFalsy: true,
  ...
  ChangePasswordValidator: [
    ...
    body("newpassword")
      ...
      .withMessage(
        "newpassword it nhat 8 ki tu trong do co it nhat 1 ki tu dac biet, 1 ki tu in hoa, 1 ki tu thuong, 1 ki tu so",
      )
      .bail()
      .custom((value, { req }) => {
